    ...
    return [
        {
            ...
            "party": "",
            "ticker": "UPLOAD",
            "title": "Imported executive interview sample",
            "source_url": "Add transcript source URL when available",
            "text": "An imported executive interview can be added here for analysis of demand, margins, regulation, technology investment, supply chain exposure, and risk language.",
        },
        {
            "id": "schema-news",
            "date": "2026-05-12",
            ...
            "party": "",
            "ticker": "UPLOAD",
            "title": "Imported market news sample",
            "source_url": "Add article URL when rights allow",
            "text": "An imported news excerpt can be added here when redistribution rights allow. The project keeps source handling explicit and conservative.",
        },
    ]
